  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-[500px] p-6 rounded-xl shadow-lg relative">
        {/* Header */}
        <h2 className="text-[#00296B] text-xl font-bold text-center mb-6">MCT Mock Test</h2>
        ...
        <div className="text-center mb-6">
          <p className="text-[#00296B] font-medium mb-2">Sections Name</p>
        ...
        <div className="text-center mb-6">
          <div className="relative w-24 h-24 mx-auto">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-[#00296B]">
        ...
        <div className="flex justify-between">
          ...
          <button
            className="bg-[#FDC500] text-[#00296B] text-lg px-6 py-2 rounded-full"
            onClick={onFinish}
          >
            Finish
          </button>
