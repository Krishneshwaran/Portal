...
const QuestionDetails = ({ selectedQuestion, setSelectedQuestion, isEditing, setIsEditing, handleUpdate, isLoading, setShowConfirm }) => {
                ...
                <>
                  <button
                    onClick={() => {
                      ...
                      toast.success("Question updated successfully!"); // Add success toast
                    }}
                    disabled={isLoading}
