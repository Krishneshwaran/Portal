  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-10 transform transition-all duration-300 scale-100 opacity-100">
        ...
        <p className="text-sm text-[#000975] mb-4">
          Upload a CSV file containing multiple questions. Maximum file size: 5MB
        </p>
        <button
          onClick={handleDownloadSample}
          className="mb-4 w-full bg-[#E3E3E3] bg-opacity-70 text-[#000975] hover:bg-[#E3E3E3] hover:bg-opacity-100 py-2 px-4 rounded-md text-sm font-medium flex justify-between items-center"
        >
        ...
        <input
          ...
          accept=".csv"
          className="block w-full text-sm text-[#000975] file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-[#FDC500] border-[#fdc500] file:bg-opacity-40 file:text-[#000975] hover:file:bg-[#FDC500] hover:file:bg-opacity-100"
        />
