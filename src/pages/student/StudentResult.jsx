...
const StudentResult = () => {
  ...
  const { attended_questions, grade, status, start_time, finish_time, red_flags, fullscreen, tabswitchwarning, facewarning, noisewarning, correct_answers, student, passPercentage } = testData;
